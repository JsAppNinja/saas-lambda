  ...
  switch (method) {
    case 'GET':
      ...
      const response1 = successResponse({
        message: 'We are getting your requested subscription coupons information!',
        input: event,
        // content: oneCustomer,
      });
      return response1;
    case 'PUT':
      ...
      const response2 = successResponse({
        message: 'We are updating your requested subscription coupons information!',
        input: event,
        content: result,
      });
      return response2;
    default:
      const generalResponse = successResponse({
        message: 'We are handling your requested subscription coupons information!',
        input: event,
      });
