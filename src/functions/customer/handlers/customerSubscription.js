  ...
  switch (method) {
    case 'GET':
      ...
      const response1 = successResponse({
        message: 'We are getting your requested subscription information!',
        input: event,
        // content: oneCustomer,
      });
      return response1;
    case 'POST':
      ...
      const response2 = successResponse({
        message: 'We are updating your requested subscription information!',
        input: event,
        content: result,
      });
      return response2;
    case 'DELETE':
      ...
      const response3 = successResponse({
        message: 'We are deleting your requested subscription information!',
        input: event,
        content: isDeleted,
      });
      return response3;
    default:
      const generalResponse = successResponse({
        message: 'We are handling your requested subscription information!',
        input: event,
      });
