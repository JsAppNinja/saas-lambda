module.exports = {
  ...
  CUSTOMER_LOG_ANALYSERS: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RULESETS: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RULESET: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RULES: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RULE: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RAWS: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RAW: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RAW_VALIDATE: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RESULTS: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RESULT: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RESULTS_LTS: '/augmentt/customer',
  CUSTOMER_LOG_ANALYSER_RESULT_EXPORT: '/augmentt/customer',
  CUSTOMER_INVOICES: '/augmentt/customer',
  CUSTOMER_INVOICE: '/augmentt/customer',
  CUSTOMER_INVOICE_PAY: '/augmentt/customer',
};
